/*
* Copyright (c) 2013 josh.salverda (http://code.google.com/p/datepickr/)
* Dual licensed under the Apache License 2.0.
*
*/
var datepickr = function () {
    function q(a, c) { var b = 0, j = a.length; for (b; b < j && !1 !== c(a[b], b) ; b++); } function p(a, c, b) { a.addEventListener ? a.addEventListener(c, b, !1) : a.attachEvent && a.attachEvent("on" + c, function (c) { var d = c = c || window.event; c.preventDefault = function () { d.returnValue = !1 }; var f = c; c.stopPropagation = function () { f.cancelBubble = !0 }; c.target = c.srcElement; b.call(a, c) }) } function d(a, c, b) {
        a in r || (r[a] = document.createElement(a)); a = r[a].cloneNode(!1); if (null != c) for (var d in c) a[d] = c[d]; null != b && ("object" ==
